...
此算法以256个字节为一个块，以一字节所对应的进制——256进制作为大进制，而选择其一半的128进制作为小进制。针对超出127的字节，我还设计了flag位，如果有超出就将其减到128以下，使得得以压缩。该算法仅循环一次是没有多大效果的，循环次数越多，压缩效果越明显。  
